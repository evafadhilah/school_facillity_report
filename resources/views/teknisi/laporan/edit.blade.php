...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="info-box mb-4">
            <p style="font-weight:700; color:#4338ca; margin-bottom:0.75rem;"><i class='bx bx-info-circle me-1'></i>
                Informasi Laporan</p>
            <div class="info-row">
                <div class="info-item">
                    <label>Pelapor</label>
                ...
                <div class="info-item">
                    ...
                    @if ($laporan->cover)
                        <div>
                            <img src="{{ Storage::url($laporan->cover) }}" class="foto-sebelum"
                                onclick="window.open('{{ Storage::url($laporan->cover) }}')" title="Klik untuk lihat full">
        ...
        <div class="card form-card">
            <div class="card-body">
                <form action="{{ route('teknisi.laporan.update', $laporan->id) }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="catatan_teknisi" class="form-control @error('catatan_teknisi') is-invalid @enderror" rows="3"
                            placeholder="Tuliskan catatan penanganan...">{{ old('catatan_teknisi', $laporan->catatan) }}</textarea>
                    </div>
