...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="index-header">
        <div class="header-content">
            <div class="header-title">
                <h4>Edit Kategori</h4>
                <p>Perbarui data kategori fasilitas sekolah</p>
            </div>
    ...
    @if ($errors->any())
        <div class="alert alert-dismissible fade show mb-4" role="alert"
             style="border-radius:12px; border:none; background:#fee2e2; color:#991b1b;">
    ...
    <div class="card form-card">
        <div class="card-body">
            <form action="{{ route('admin.kategori.update', $kategori->id) }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="form-label"><i class='bx bx-category me-1'></i> Nama Kategori</label>
                    <input type="text" name="nama_kategori"
                        class="form-control @error('nama_kategori') is-invalid @enderror"
                        value="{{ old('nama_kategori', $kategori->nama_kategori) }}"
                        placeholder="Contoh: Elektronik, Mebel, Sanitasi"
                        required>
                    @error('nama_kategori')
